...
window.boot = function () {
  ...
  if (false) {
    ...
    var bundledScript = 'https://cdn.jsdelivr.net/gh/Slackboi/zjl/src/project.min.js?ran=' + Math.random().toString("32").substring(2);
    if (jsList) {
      jsList = jsList.map(function (x) {
        return 'https://cdn.jsdelivr.net/gh/Slackboi/zjl/src/' + x;
      });
...
if (false) {
  BK.Script.loadlib('GameRes:https://cdn.jsdelivr.net/gh/Slackboi/zjl/src/settings.js');
  BK.Script.loadlib();
  ...
  if (isRuntime) {
    require('https://cdn.jsdelivr.net/gh/Slackboi/zjl/src/settings.js');
    require('https://cdn.jsdelivr.net/gh/Slackboi/zjl/src/cocos2d-runtime.min.js');
    require('jsb-adapter/engine/index.js');
  } else {
    require('https://cdn.jsdelivr.net/gh/Slackboi/zjl/src/settings');
    require('https://cdn.jsdelivr.net/gh/Slackboi/zjl/src/cocos2d-jsb.js');
